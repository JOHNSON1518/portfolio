        ...
        <motion.div className="textContainer" variants={contactVariants}>
            ...
            <motion.div className="conItem" variants={contactVariants}>
                ...
                <div className="social-links">
                  <a href="mailto:johnsonffrancis.a@gmail.com" target='_blank'>
                      ...
                      <span>johnsonffrancis.a@gmail.com</span>
                  </a>
                </div>
            </motion.div>
            <motion.div className="conItem" variants={contactVariants}>
                <h2>Phone</h2>
                <div className="social-links">
                  <a href="tel:+919361610134" target='_blank'>
                      <img src="/phone.png" className='phone' alt="" />
                      <span>+91 9361610134</span>
                  </a>
                </div>
            </motion.div>
            <motion.div className="conItem" variants={contactVariants}>
            ...
            <motion.div className="conItem" variants={contactVariants}>
              ...
              <div className="social-links">
                ...
                <a href="https://https://profile.indeed.com/p/johnsona-359hw3b/" target='_blank'>
